...
import { PaymentStatus, Roles } from "../../../generated/prisma/enums";
...
export const MyReviewsService = async (user: IRequestUser) => {
  ...
  if (isUserExist.role === Roles.DOCTOR) {
  ...
  if (isUserExist.role === Roles.PATIENT) {
